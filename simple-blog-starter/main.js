    ...
    if (modal) {
        ...
        .then((data)=>{
           ...
           data.postComments.forEach((el) => {
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border0 border-gray-100">
...
const Categories = ["Technology", "Sports","Arts","Health","Books","Games"]
...
.then((data)=>{
    ...
    data.forEach(element =>{
        catButtons.innerHTML +=`
                             <button
                                onclick="CateggorySelect(${element.id})"
